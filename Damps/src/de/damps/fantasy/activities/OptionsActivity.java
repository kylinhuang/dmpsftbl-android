...
public class OptionsActivity extends Activity {
	...
	private void initialiseScreen() {
		...
		if (pref.getBoolean("chron", false)) {
			((RadioGroup) findViewById(R.id.rg_opt_Group1))
					.check(R.id.rb_options_unten);
		} else {
			((RadioGroup) findViewById(R.id.rg_opt_Group1))
					.check(R.id.rb_options_oben);
		}
	}
	...
	public void setDomain(View view) {
		...
		editor.commit();
		String msg = getString(R.string.domain_set) + " " + dom + " "
				+ getString(R.string.setted);
	...
	public void setNewsNumber(View view) {
		...
		editor.commit();
		String msg = getString(R.string.news_set) + " " + number + " "
				+ getString(R.string.setted);
		Toast toast = Toast.makeText(getApplicationContext(), msg,
				Toast.LENGTH_LONG);
		toast.show();
	...
	public void setOrientation(View view) {
		if (oben.isChecked()) {
			...
			editor.commit();
			String msg = getString(R.string.posts_set) + " oben "
			...
			editor.commit();
			String msg = getString(R.string.posts_set) + " unten "
					+ getString(R.string.show);
			Toast toast = Toast.makeText(getApplicationContext(), msg,
					Toast.LENGTH_LONG);
			toast.show();
	...
	public void setThreadsNumber(View view) {
		...
		editor.commit();
		String msg = getString(R.string.threads_set) + " " + number + " "
				+ getString(R.string.setted);
		Toast toast = Toast.makeText(getApplicationContext(), msg,
				Toast.LENGTH_LONG);
		toast.show();
