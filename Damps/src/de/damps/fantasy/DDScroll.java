 ...
 */
public class DDScroll extends FrameLayout {
	...
	public DDScroll(Context context) {
		super(context);
		initTwoDScrollView();
	}

	public DDScroll(Context context, AttributeSet attrs) {
		super(context, attrs);
		initTwoDScrollView();
	}

	public DDScroll(Context context, AttributeSet attrs, int defStyle) {
